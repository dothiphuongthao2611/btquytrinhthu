        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- Nút thêm -->
                    <a href="them.php" class="btn btn-primary1 mb-3 add-button">Thêm sách</a>
                    ...
                    <table class="content-table">
                        ...
                        <tbody id="book-list">
                            ...
                            $sql = "SELECT * FROM themsach LIMIT $start, $limit";
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- Nút xem -->
                                    <a href="./xem.php?bookID=<?php echo $row["bookID"]; ?>" class="btn btn-danger">Xem</a>
                                    <!-- Nút sửa -->
                                    <a href="./sua.php?bookID=<?php echo $row["bookID"]; ?>" class="btn btn-danger">Sửa</a>
                                    <!-- Nút xoá -->
                                    <button class="btn btn-danger delete-button" data-bookid="<?php echo $row["bookID"]; ?>">Xoá</button>
                                </td>
                            </tr>
                            <?php
                                }
                            ...
                            <?php
                             ...
                             // Tính tổng số trang
                             $sqlTotal = "SELECT COUNT(*) AS total FROM themsach";
                    ...
                    <div class="pagination">
                        ...
                        for ($i = 1; $i <= $totalPages; $i++) {
                            ...
                            echo '<a href="thu.php?page=' . $i . '" class="' . $activeClass . '">' . $i . '</a>';
                        }
                        ?>
                    </div>
        ...
        $(document).ready(function() {
            ...
            $('.delete-button').click(function() {
                ...
                if (confirm("Bạn có chắc chắn muốn xóa sách này không?")) {
                    ...
                    $.ajax({
                        url: `http://localhost/BTL/controller/delete.php?bookID=${bookID}`,
                        type: 'DELETE',
