...
<body>
    <div id="admin-content">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="admin-heading">SỬA PHIẾU MƯỢN</h2>
                    <!-- Form sửa sách với phương thức POST -->
                    <form id="edit-book-form" method="PUT" action="http://localhost/BTL/controller/update_phieu_muon.php">
                        ...
                        <table class="content-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="number" name="bookId" value="<?php echo isset($bookId) ? $bookId : ''; ?>" required></td>
                                    <td><input type="number" name="readerID" value="<?php echo isset($readerID) ? $readerID : ''; ?>" required></td>
                                    <td><input type="number" name="so_luong" value="<?php echo isset($so_luong) ? $so_luong : ''; ?>" required></td>
                                    <td><input type="text" name="phi_muon" value="<?php echo isset($phi_muon) ? $phi_muon : ''; ?>" required></td>
                                    <td><input type="date" name="ngay_muon" value="<?php echo isset($ngay_muon) ? $ngay_muon : ''; ?>" required></td>
                                    <td><input type="date" name="ngay_tra" value="<?php echo isset($ngay_tra) ? $ngay_tra : ''; ?>" required></td>
